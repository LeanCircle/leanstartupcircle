  ...
  describe "validates" do
    ...
    describe "uniqueness of uid" do
      ...
      describe "scoped to provider" do
        subject { build :authentication, :provider => "twitter", :uid => "12345" }

        it { create :authentication, :provider => "twitter", :uid => "12345"
             should_not be_valid }
        it { create :authentication, :provider => "meetup", :uid => "12345"
             should be_valid }
      end
    end
  end
