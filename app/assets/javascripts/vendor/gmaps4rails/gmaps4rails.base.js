(function() {
  ...
  this.Gmaps4Rails = (function() {
    ...
    Gmaps4Rails.prototype.createSidebar = function(marker_container) {
      var aSel, currentMap, html, table, tr;
      if (this.markers_conf.list_container) {
        table = document.getElementById(this.markers_conf.list_container);
        ...
        tr.innerHTML = html;
        currentMap = this;
        tr.onclick = this.sidebar_element_handler(currentMap, marker_container.serviceObject, 'click');
